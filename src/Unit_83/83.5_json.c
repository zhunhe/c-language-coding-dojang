...
int main()
{
	...
	char *doc = readFile("83.5_example.json", &size);
	if (doc == NULL)
		return -1;
	...
	printf("Actors:\n");
	printf("  %s\n", json.tokens[11].string);            // 토큰에 저장된 문자열 출력(Actors 요소)
	printf("  %s\n", json.tokens[12].string);            // 토큰에 저장된 문자열 출력(Actors 요소)
	printf("  %s\n", json.tokens[13].string);            // 토큰에 저장된 문자열 출력(Actors 요소)
	printf("  %s\n", json.tokens[14].string);            // 토큰에 저장된 문자열 출력(Actors 요소)
	printf("  %s\n", json.tokens[15].string);            // 토큰에 저장된 문자열 출력(Actors 요소)
