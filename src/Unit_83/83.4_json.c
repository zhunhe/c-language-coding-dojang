...
int main()
{
	...
	char *doc = readFile("83.4_example.json", &size);
	if (doc == NULL)
		return -1;
	...
	printf("Actors:\n");
	printf("  %s\n", json.tokens[7].string);         // 토큰에 저장된 문자열 출력(Actors의 요소)
	printf("  %s\n", json.tokens[8].string);         // 토큰에 저장된 문자열 출력(Actors의 요소)
	printf("  %s\n", json.tokens[9].string);         // 토큰에 저장된 문자열 출력(Actors의 요소)
	printf("  %s\n", json.tokens[10].string);        // 토큰에 저장된 문자열 출력(Actors의 요소)
	printf("  %s\n", json.tokens[11].string);        // 토큰에 저장된 문자열 출력(Actors의 요소)
